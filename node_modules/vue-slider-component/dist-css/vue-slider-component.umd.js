  ...
  control_createClass(Control, [{
    ...
    get: function get() {
      ...
      var getMarkByValue = function getMarkByValue(value, mark) {
        var pos = _this4.parseValue(value);

        return _objectSpread({
          pos: pos,
          value: value,
          label: value,
          active: _this4.isActiveByPos(pos)
        }, mark);
      };
  ...
  vue_slider_createClass(VueSlider, [{
    ...
    value: function initControl() {
      ...
      ['data', 'enableCross', 'fixed', 'max', 'min', 'interval', 'minRange', 'maxRange', 'order', 'marks', 'process', 'adsorb', 'included', 'dotOptions'].forEach(function (name) {
        _this7.$watch(name, function (val) {
          if (name === 'data' && Array.isArray(_this7.control.data) && Array.isArray(val) && _this7.control.data.length === val.length && val.every(function (item, index) {
    ...
    value: function dragEnd(e) {
      ...
      setTimeout(function () {
        ...
        if (_this8.included && _this8.isNotSync) {
          _this8.control.setValue(_this8.value);
        } else {
          // Sync slider position
    ...
    value: function setValueByPos(pos) {
      ...
      setTimeout(function () {
        if (_this10.included && _this10.isNotSync) {
          _this10.control.setValue(_this10.value);
        } else {
    ...
    value: function render() {
      ...
      return h("div", helper_default()([{
        ...
        return _this12.renderSlot('process', item, h("div", {
        ...
        return _this12.renderSlot('mark', mark, h("vue-slider-mark", {
        ...
        }, [_this12.renderSlot('step', mark, null), _this12.renderSlot('label', mark, null)]), true);
        ...
        return h("vue-slider-dot", {
          ...
          "nativeOn": {
            "focus": function focus() {
              return !dot.disabled && _this12.focus(index);
            },
            "blur": function blur() {
              return _this12.blur();
            }
          }
        }, [_this12.renderSlot('dot', dot, null), _this12.renderSlot('tooltip', dot, null)]);
