              ...
              <div class="col-lg-6">
                <div class="subscribe">
                  <div>
                    ...
                    <p>Never Miss Anything From NiconKART By Signing Up To Our Newsletter.</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
              ...
              <div class="sub-title">
                ...
                <div class="footer-contant">
                  <ul class="contact-list">
                    <li>
                      <i class="fa fa-map-marker"></i>NiconKART  Store
                    </li>
                    <li>
                      <i class="fa fa-phone"></i>Call Us: 08102353377
                    </li>
                    <li>
                      <i class="fa fa-envelope-o"></i>Email Us:
                      <a href="#">Uchechidi9@gmail.com</a>
                    </li>
                    <!-- <li>
          ...
          <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
              <div class="footer-end">
                <p>
                  <i class="fa fa-copyright" aria-hidden="true"></i> 2022  ecommerce powered by niconet
                </p>
              </div>
            </div>
            <div class="col-xl-6 col-md-6 col-sm-12">
