...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/modules/address.js'), 'modules/address.js')
  resolveStoreModules(require('../store/modules/authuser.js'), 'modules/authuser.js')
  ...
  resolveStoreModules(require('../store/modules/products2.js'), 'modules/products2.js')
